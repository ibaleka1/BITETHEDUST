...
const VERAOrb: React.FC = () => {
  ...
  return (
    <div className="vera-orb-wrapper">
      <div ref={orbRef} className="vera-orb" onClick={activate} tabIndex={0} role="button" aria-label="Activate VERA">
        <span className="vera-orb-glow"></span>
        <span className="vera-orb-inner"></span>
      </div>
      <div style={{marginTop: 12, color: "#555"}}>Click the orb to activate VERA</div>
    </div>
  );
};
